...
const get_api_webDB_test_1 = __importDefault(require("./suites/get-api-webDB.test"));
const privateJSON_test_1 = __importDefault(require("./suites/privateJSON.test"));
describe("webServer", function () {
    get_api_config_test_1.default.bind(this)();
    post_api_config_test_1.default.bind(this)();
    get_api_webDB_test_1.default.bind(this)();
    privateJSON_test_1.default.bind(this)();
});
